...
function CreateModelShips()
    ...
    for i=1,25 do
        local shipData = {
            ...
            destination = galaxy.stars[RAND(1,#galaxy.stars)],
...
function DisplayShips()
    ...
    for i=1,25 do
        ...
        shipModel.destination = destinationStar
...
function DisplayBorders()
    ...
    for i=1,#galaxy.empires do
        if(galaxy:GetBorderForEmpire(galaxy.empires[i])~=nil)then
            -- Pick the colors
